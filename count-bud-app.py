...
def main(argv):
    ...
    try:
        ...
        print('count-bud-app.py -i <inputfile> -o <outputfile>')
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print('count-bud-app.py -i <inputfile> -o <outputfile>')
    ...
    ret,thresh = cv.threshold(gray_correct, 50,255,cv.THRESH_BINARY)
    ...
    cv.imwrite(outputfile, labeled_img)
    # plt.show()
